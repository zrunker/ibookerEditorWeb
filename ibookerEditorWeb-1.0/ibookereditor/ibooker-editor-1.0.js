...
// 编辑器的默认高度和宽度
var ibookerEditorHeight, ibookerEditorWidth;
...
function setEditorHeight() {
	...
	if (editorP != null && editorP != undefined && editorP != "") {
		editorP.style.height = (eheight - 40) + "px";
	}
	// 计算编辑器的高度/宽度
...
ibookerEditor.createView = function() {
	...
	ibookerEditorHtml += "<li class='ibooker-pull-right ibooker_help' title='帮助'><a id='editor_help' href='http://www.ibooker.cc/article/1/detail' target='_blank'></a></li>";
 ...
 * 31、editorOptions.isOpenUndoEvent 是否开启撤销事件true/false，默认true
 * 32、editorOptions.isOpenRedoEvent 是否开启重做事件true/false，默认true
 * 33、editorOptions.isOpenHelpEvent 是否开启帮助事件true/false，默认true
 * 34、editorOptions.isOpenPreviewEvent 是否开启预览模式事件true/false，默认true
 * 35、editorOptions.isOpenLiveEvent 是否开启实况模式事件true/false，默认true
 * 36、editorOptions.isOpenEditEvent 是否开启编辑模式事件true/false，默认true
 * 37、editorOptions.isOpenZenEvent 是否开启全屏事件true/false，默认true
 */
...
//			eConverter.setOption("completeHTMLDocument", true);
	...
	function compile() {
		...
		if (editorC != null && editorC != undefined && editorC != "" && editorP != null && editorP != undefined && editorP != "") {
			var html = ibookerEditor.sdConverter.converToHtml(editorC.value);
			editorP.innerHTML = html;
			// 重置输入框的高度
